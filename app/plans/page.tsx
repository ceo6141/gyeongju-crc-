    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <Icons.Target className="h-16 w-16 text-primary mx-auto mb-4" />
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Icons.CheckCircle className="h-5 w-5 mr-2 text-green-600" />
                  지역사회 봉사
                </CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Icons.CheckCircle className="h-5 w-5 mr-2 text-blue-600" />
                  청소년 지원
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Icons.CheckCircle className="h-5 w-5 mr-2 text-purple-600" />
                  국제봉사
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <Icons.CheckCircle className="h-5 w-5 mr-2 text-orange-600" />
                  클럽 발전
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
