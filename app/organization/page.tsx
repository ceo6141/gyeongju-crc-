...
const getDefaultOrganizationData = (): OrganizationData => ({
  executives: [
    ...
    { id: "2", position: "회장", name: "천상天翔 최용환", type: "main" },
    ...
    { id: "7", position: "감사", name: "남정악", type: "sub" },
  ],
  committees: [
    {
      id: "1",
      name: "클럽관리위원회",
      chairman: "조현우",
      members: ["최병준", "이상익", "서상호", "황병욱", "박임관", "박준민"],
    },
    {
      id: "2",
      name: "멤버십(회원)위원회",
      chairman: "김용환",
      members: ["최원식", "황현호", "김일래", "최지호", "한기운", "윤대한"],
    },
    {
      id: "3",
      name: "공공이미지(홍보)위원회",
      chairman: "전종필",
      members: ["정재근", "황대환", "박원수", "김동해", "김동수", "임도경"],
    },
    {
      id: "4",
      name: "봉사프로젝트위원회",
      chairman: "권국창",
      members: ["한동균", "권덕용", "조윤철", "손동균", "황해진", "이경보"],
    },
    {
      id: "5",
      name: "로타리재단위원회",
      chairman: "윤태열",
      members: ["이기삼", "구대학", "김태규", "정연철", "황영석", "이현호"],
    },
    {
      id: "6",
      name: "청소년(신세대)위원회",
      chairman: "이성민",
      members: ["손대호", "최은호", "김원준", "이락우", "김기태", "이주형"],
    },
  ],
  specialCommittees: [
    {
