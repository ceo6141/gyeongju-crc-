        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-semibold">경주중앙로타리클럽</h3>
            </div>
            <p className="text-muted-foreground mb-4">
              봉사를 통한 지역사회 발전과 국제친선을 도모하는 경주중앙로타리클럽입니다.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground">이메일: (추후 업데이트)</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-4 w-4 text-primary" />
                <span className="text-muted-foreground">경주시 승삼기1길 5-5, 4층(용강동)</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-4 w-4 text-primary" />
                <span className="text-muted-foreground">우편번호: (추후 업데이트)</span>
              </div>
            </div>
          </div>
